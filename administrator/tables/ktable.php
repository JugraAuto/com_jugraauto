 ...
 * city Table class
 */
class JugraautoTableKtable extends JTable {
...
//        if(!JFactory::getUser()->authorise('core.edit.state','com_jugraauto.city.'.$array['id']) && $array['state'] == 1){
//                $array['state'] = 0;
//        }
    ...
    */
    protected function _getAssetName() {
        $k = $this->_tbl_key;
        return 'com_jugraauto.'.$this->asset_name.'.' . (int) $this->$k;
    }
    ...
    */
    protected function _getAssetParentId($table = null, $id = null){
        ...
        $assetParent->loadByName('com_jugraauto');
     ...
     */
    public function get_rows($keys=FALSE) 
    {
...
//        var_dump($this->_db->loadObjectList());exit;
	 ...
	 * @since	1.6
	 */
	public function getTable($type = '', $prefix = 'JugraautoTable', $config = array())
	{
            if(!$type)
            {
